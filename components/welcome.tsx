...
export default function Welcome() {
    return (
        <div className="bg-gray-100 h-full flex items-center justify-center relative">
            <div className="text-center">
                ...
                <h1 className="text-3xl mb-5"> WhatsApp Web</h1>
            ...
            <footer className="text-sm text-gray-400 flex items-center gap-2 absolute bottom-10">
                <FaLock className="size-3"></FaLock>
